...
import { LayoutDashboard, CalendarPlus, Calculator, Settings } from 'lucide-react'
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-20 bg-white border-t safe-area-pb">
      <div className="flex">
